...
if (isset($_GET['prodID'])) {
    ...
    if ($product) {
        ...
        header("Location: bronze_member.php?product_added=true");
        exit();
    }
}
...
<head>
    ...
    <title>Miraé - Bronze Member</title>
    <style>
...
<div style="display: flex; justify-content: space-between; align-items: center; padding: 20px;">
    <h2 style="margin: 0 auto; text-align: center; flex-grow: 1;">
        Welcome, <?= htmlspecialchars($user_name) ?> - Miraé Bronze Member
    </h2>
    <div style="flex-shrink: 0;">
        <a href="bronzeCart.php" class="view-cart-button">🛒 View Cart</a>
    </div>
</div>
                ...
                <?php while ($product = $result->fetch_assoc()): ?>
                    <div class="product-card">
                        ...
                        <div class="product-info">
                            ...
                            <a href="bronze_member.php?prodID=<?php echo htmlspecialchars($product['prodID']); ?>" class="add-to-cart">Add to Cart</a>
                        </div>
                    </div>
                <?php endwhile; ?>
            </div>
