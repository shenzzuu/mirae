...
if (isset($_GET['action']) && isset($_GET['prodID'])) {
    ...
    unset($item);
    header("Location: bronzeCart.php");
    exit();
}
?>
...
<head>
    <meta charset="UTF-8">
    <title>Bronze Member Cart - Miraé</title>
    ...
    <div class="cart-container">
        ...
        <?php if (!empty($_SESSION['cart'])): ?>
                ...
                <tbody>
                    ...
                    <?php foreach ($_SESSION['cart'] as $item): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="bronzeCart.php?action=decrease&prodID=<?php echo $item['prodID']; ?>" class="qty-btn">-</a>
                                <?php echo $quantity; ?>
                                <a href="bronzeCart.php?action=increase&prodID=<?php echo $item['prodID']; ?>" class="qty-btn">+</a>
                            </td>
                            <td>RM <?php 
            ...
            <div class="cart-summary">
                ...
                <a href="bronzeCheckout.php" class="checkout-btn">Proceed to Checkout</a>
            </div>
        <?php else: ?>
